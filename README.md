...
Este repositorio contiene la solución a la evaluación final del Módulo 2 de SQL del bootcamp "Data Analytics & AI" de Adalab, utilizando la base de datos "SAKILA". 


## Descripción: 

La evaluación consiste en resolver 24 ejercicios de SQL sobre la base de datos "SAKILA", que simula una tienda de alquiler de películas. Las consultas abarcan desde operaciones básicas hasta el uso de subsoncultas, joins y funciones de agregación. 


## Estructura del Proyecto: 

- BBDD_SAKILA_Screenshot_MySQLWorkbench.png
- Evaluación_Final_Módulo_2_SQL_Patricia_Merchán.sql
- README.md


## Archivo: 

El archivo 'Evaluación_Final_Módulo_2_SQL_Patricia_Merchán.sql' contiene la solución a los 24 ejercicios propuestos. 


## Ejemplo de estructura de las consultas (el número de pasos en cada consulta puede variar): 

/* 
EJERCICIO X: 
[Enunciado del ejercicio]

-- Paso 1: Exploración inicial de las tablas relevantes
SELECT *
    FROM tabla1; 
SELECT *
    FROM tabla2; 

-- Paso 2: Pruebas intermedias para entender las relaciones 
